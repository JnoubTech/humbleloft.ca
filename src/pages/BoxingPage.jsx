...
const boxingConfig = {
  hero: {
    ...
    bgVideo: '/images/extracted/boxing/boxing_video_00.mp4',
  },
  training: {
    ...
    video: '/images/extracted/boxing/boxing_video_01.mp4',
  ...
  coach: {
    ...
    image: '/images/extracted/boxing/boxing_image_02.jpg',
  ...
  features: {
    ...
    items: [
      {
        icon: <img src="/images/extracted/boxing/boxing_image_06.png" alt="Self-defense" />,
        label: 'Self-defense',
        sublabel: null,
      },
      {
        icon: <img src="/images/extracted/boxing/boxing_image_04.png" alt="Fitness + Conditioning" />,
        label: 'Fitness + Conditioning',
        sublabel: null,
      },
      {
        icon: <img src="/images/extracted/boxing/boxing_image_01.png" alt="Future Competitors" />,
